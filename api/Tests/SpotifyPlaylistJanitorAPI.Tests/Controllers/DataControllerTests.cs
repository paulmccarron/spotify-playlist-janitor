...
namespace SpotifyPlaylistJanitorAPI.Tests.Controllers
{
    ...
    public class DataControllerTests : TestBase
    {
        ...
        public async Task DataController_GetMonitoredPlaylist_Returns_DatabasePlaylistModel()
        {
            ...
            // Assert
            MockDatabaseService.Verify(mock => mock.GetPlaylist(It.Is<string>(s => s.Equals(USERNAME)), It.Is<string>(s => s.Equals(id))), Times.Once);
        ...
        public async Task DataController_CreateMonitoredPlaylist_Returns_DatabasePlaylistModel()
        {
            ...
            // Assert
            MockDatabaseService.Verify(mock => mock.GetPlaylist(It.Is<string>(s => s.Equals(USERNAME)), It.Is<string>(s => s.Equals(databaseRequest.Id))), Times.Once);
